...
kha_Shaders.init = function() {
	...
	var data1 = Reflect.field(kha_Shaders,"painter_image_vertData");
	var bytes1 = haxe_Unserializer.run(data1);
	kha_Shaders.painter_image_vert = new kha_graphics4_VertexShader(kha_internal_BytesBlob.fromBytes(bytes1),"painter_image_vert");
	var data2 = Reflect.field(kha_Shaders,"painter_text_vertData");
	var bytes2 = haxe_Unserializer.run(data2);
	kha_Shaders.painter_text_vert = new kha_graphics4_VertexShader(kha_internal_BytesBlob.fromBytes(bytes2),"painter_text_vert");
	var data3 = Reflect.field(kha_Shaders,"painter_video_fragData");
	var bytes3 = haxe_Unserializer.run(data3);
	kha_Shaders.painter_video_frag = new kha_graphics4_FragmentShader(kha_internal_BytesBlob.fromBytes(bytes3),"painter_video_frag");
	var data4 = Reflect.field(kha_Shaders,"painter_video_vertData");
	var bytes4 = haxe_Unserializer.run(data4);
	kha_Shaders.painter_video_vert = new kha_graphics4_VertexShader(kha_internal_BytesBlob.fromBytes(bytes4),"painter_video_vert");
	var data5 = Reflect.field(kha_Shaders,"painter_image_fragData");
	var bytes5 = haxe_Unserializer.run(data5);
	kha_Shaders.painter_image_frag = new kha_graphics4_FragmentShader(kha_internal_BytesBlob.fromBytes(bytes5),"painter_image_frag");
	...
	kha_Shaders.painter_colored_vert = new kha_graphics4_VertexShader(kha_internal_BytesBlob.fromBytes(bytes7),"painter_colored_vert");
};
